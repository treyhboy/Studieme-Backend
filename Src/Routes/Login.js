                ...
                request.get(
                    ...
                    function (error, response, body) {
                        ...
                        var email = JSON.parse(body).emailAddress;
                            ...
                            .then(function(user) {
                                if (user) {
                                    res.send({status:true,message:"user exist",token:createToken(user)})
                                } else {
                                    ud
                                        .create({
                                            username: email,
                                        ...
                                        .then(function(user) {
                                            ...
                                            // console.log(decoded);
                                            res.send({status:true,t,firstName:body.firstName,lastName:body.lastName,pictureUrl:body.pictureUrl,data:body});
